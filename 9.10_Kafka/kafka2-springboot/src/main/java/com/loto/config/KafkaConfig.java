...
public class KafkaConfig {
    ...
    public KafkaAdmin kafkaAdmin() {
        ...
        configs.put("bootstrap.servers", "192.168.31.246:9092");
    ...
    public KafkaTemplate<Integer, String> kafkaTemplate(ProducerFactory<Integer, String> producerFactory) {
        ...
        KafkaTemplate<Integer, String> template = new KafkaTemplate<Integer, String>(producerFactory, configsOverride);
        return template;
    }
}
