...
/**
 * 雪花算法（Java语言，官方为Scala语言）
 */
public class b_SnowFlake_IdWorker {
    ...
    public b_SnowFlake_IdWorker(long workerId, long datacenterId, long sequence) {
    ...
    public static void main(String[] args) {
        b_SnowFlake_IdWorker worker = new b_SnowFlake_IdWorker(21, 10, 0);
        for (int i = 0; i < 100; i++) {
