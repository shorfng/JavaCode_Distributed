package com.loto.rpc.handler;

import com.alibaba.fastjson.JSON;

import com.loto.rpc.anno.RpcService;
import com.loto.rpc.common.RpcRequest;
import com.loto.rpc.common.RpcResponse;
...
public class RpcServerHandler extends SimpleChannelInboundHandler<String> implements ApplicationContextAware {
    ...
    public Object handler(RpcRequest rpcRequest) throws InvocationTargetException {
        ...
        if (serviceBean == null) {
            throw new RuntimeException("根据 beanName 找不到服务，beanName:" + rpcRequest.getClassName());
        }
