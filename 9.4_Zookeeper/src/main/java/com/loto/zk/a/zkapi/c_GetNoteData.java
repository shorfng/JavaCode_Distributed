 ...
 * <p>PageName：c_GetNoteData.java</p>
 * <p>Function：获取节点数据</p>
 */

public class c_GetNoteData implements Watcher {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        zooKeeper = new ZooKeeper("192.168.31.246:2181", 5000, new c_GetNoteData());
    ...
    public void process(WatchedEvent watchedEvent) {
        ...
        // 子节点列表发生改变时，服务器端会发出 noteChildrenChanged 事件通知，会重新获取子节点列表
